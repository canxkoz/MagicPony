...
result_folders = {
    'ours_release_016': 'results/birds/sisko3/test_results',

    'ours_ab_nosym_010': 'results/birds/sisko3/test_results',
    'ours_ab_nozflip_010': 'results/birds/sisko3/test_results',
    'ours_ab_noflow_010': 'results/birds/sisko3/test_results',
    'ours_ab_novideo_020': 'results/birds/sisko3/test_results',
    'ours_ab_noprior_008': 'results/results/birds/sisko3/test_results',
    'cmr_finetune': 'results/results/birds/00_score_data',
    'cmr_no_kp': 'results/results/birds/00_score_data',
    'ucmr_finetune': 'results/results/birds/00_score_data',
    'ucmr_no_temp': 'results/results/birds/00_score_data',
    'umr_finetune': 'results/results/birds/00_score_data',
    'umr_no_scops': 'results/results/birds/pretrained_bird',
    'umr_scratch_scops': 'results/results/birds/pretrained_bird',
    'vmr_finetune': 'results/results/birds/pretrained_bird',
    'vmr_no_kp_10k': 'results/results/birds/pretrained_bird',
    'vmr_no_kp_30k': 'results/results/birds/pretrained_bird',
}
...
scan_list.sort()
result_list.sort(key=lambda x: int(osp.basename(x).split('_')[1]))
...
for i, result_fpath in enumerate(result_list):
    ...
    if method.startswith('ours_ab_nosym_'):
        ...
        rot_mat = trimesh.transformations.euler_matrix(180*np.pi, 0, 0, 'sxyz')
